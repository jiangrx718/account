...
type SPictureBookCategory struct {
	...
	CategoryId   int       `gorm:"column:category_id;type:int(11);default:0;comment:栏目ID;NOT NULL" json:"category_id"`
	CategoryName string    `gorm:"column:category_name;type:varchar(256);comment:栏目名称;NOT NULL" json:"category_name"`
